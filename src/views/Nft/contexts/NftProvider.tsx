...
import { PANCAKE_RABBITS_ADDRESS, RABBIT_MINTING_FARM_ADDRESS } from 'config/constants/nfts'
import multicall from 'utils/multicall'
import { getPancakeRabbitsContract } from 'utils/contractHelpers'
...
const NftProvider: React.FC<NftProviderProps> = ({ children }) => {
  ...
  useEffect(() => {
    const fetchContractData = async () => {
      try {
        const pancakeRabbitsContract = getPancakeRabbitsContract(PANCAKE_RABBITS_ADDRESS)

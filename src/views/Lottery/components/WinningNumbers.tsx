...
import { CardBody, CardFooter } from '@pancakeswap-libs/uikit'
      ...
      <Card>
        ...
        <CardFooter>
          <StyledCardContentInner>            
              ...
              <Link href="https://api.cougarswap.io/api/lottery?page=0&pageSize=25" target="_blank">
...
const TicketNumberBox = styled.div`
  padding: 10px;
  border-radius: 12px;
  border: 2px dotted ${({ theme }) => theme.colors.contrast};

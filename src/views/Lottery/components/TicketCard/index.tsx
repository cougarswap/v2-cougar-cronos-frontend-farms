...
import { Card, CardBody, TicketRound2, Text, Heading } from '@pancakeswap-libs/uikit'
import useI18n from 'hooks/useI18n'
import useGetLotteryHasDrawn from 'hooks/useGetLotteryHasDrawn'
import useTickets from 'hooks/useTickets'
import useCurrentTime from 'hooks/useTimer'
import TicketActions from './TicketActions'
import { getLotterySaleTime } from '../../helpers/CountdownHelpers'
...
const TicketCard: React.FC<CardProps> = ({ isSecondCard = false }) => {
  ...
  const timeUntilTicketSale = lotteryHasDrawn && getLotterySaleTime(currentMillis)

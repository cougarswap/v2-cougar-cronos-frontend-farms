...
import { Heading, CardBody, CardFooter, Text, PancakeRoundIcon, Flex, Skeleton } from '@pancakeswap-libs/uikit'
        ...
        <CardHeading>
          <Left>
            ...
            <PrizeCountWrapper>
              ...
              <Heading size="lg">{lotteryPrizeWithCommaSeparators} CGS</Heading>
            </PrizeCountWrapper>
          </Left>
          <Right>

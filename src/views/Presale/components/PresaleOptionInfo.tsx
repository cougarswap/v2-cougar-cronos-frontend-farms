...
import { fetchUserInWhiteListAsync } from 'state/presale';
...
const PresaleOptionInfo: React.FC<PresaleOptionInfoProps> = ({
    ...
    const {isWhiteListActive} = usePresalePublicData(option)
                ...
                <CardFooter style={{borderTop: "1px solid #d18181"}} padding={['0px', '0px', '12px', '12px', '24px']}>
                    ...
                    <PresaleInfoTable>
                        <tbody>
                            ...
                            <tr>
                                <td>Presale Price:</td>
                                <td className='colored highlight-price'>${pricePerToken} USDC</td>
                            </tr>     
                            <tr>
                                <td><></></td>
